...
const booksData = [
  ...
  { title: "Heartstopper: Volume 5", author: "Alice Oseman", genre: "Romance", year: 2023, pages: 336, rating: 5, synopsis: "Com o fim do ensino médio se aproximando, Nick e Charlie olham para o futuro e os desafios da universidade e de um relacionamento à distância.", cover: "/covers/heartstopper-5.jpg", publisher: "Seguinte", language: "Português", series: "Heartstopper (Livro 5)" },
